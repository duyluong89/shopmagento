...
$table->addColumn($installer->getTable('myslideshow/slideshow'), 'price', array(
    'type'      => Varien_Db_Ddl_Table::TYPE_DECIMAL,
    'length'    => '12',
    'position'  => '3',
    'comment'   => 'price of slider'
));
$table->addColumn($installer->getTable('myslideshow/slideshow'), 'description', array(
		'type'      => Varien_Db_Ddl_Table::TYPE_TEXT,
		'length'    => '500',
		'position'  => '4',
		'comment'   => 'description of slider'
));