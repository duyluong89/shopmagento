    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('price', 'text', array(
        		'name'      => 'price',
        		'label'     => Mage::helper('myslideshow')->__('Price'),
        		'title'     => Mage::helper('myslideshow')->__('Price'),
        		'required'  => true,
        		'disabled'  => $isElementDisabled
        ));
        $fieldset->addField('description', 'textarea', array(
        		'name'      => 'description',
        		'label'     => Mage::helper('myslideshow')->__('Description'),
        		'title'     => Mage::helper('myslideshow')->__('Description'),
        		'required'  => false,
        		'disabled'  => $isElementDisabled
        ));
